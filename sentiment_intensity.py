...
def createSome(line):
    if line[5] == "neutral":
        if line[2] >= 0.15:
            return line[0], line[1], line[2], line[3], line[4], "somewhat negative", line[6]
        if line[4] >= 0.15:
            return line[0], line[1], line[2], line[3], line[4], "somewhat positive", line[6]
        else:
...
total_sent_df = total_sent.map(filter_rdd).map(createSome).toDF().selectExpr("_1 as message", "_2 as paid_for_by", "_3 as neg", "_4 as neu", "_5 as pos", "_6 as sentiment", "_7 as score")
